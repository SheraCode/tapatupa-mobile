...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _fetchPermohonanData(String idPersonal) async {
    try {
      final response = await http.get(Uri.parse('http://tapatupa.manoume.com/api/pembayaran-mobile/$idPersonal'));
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            'Kode Invoice: ${data?['noInvoice'] ?? 'Loading...'}',
                                            style: TextStyle(
                                              fontSize: 16,
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Nama Wajib Retribusi: \n${data?['npwrd'] ?? 'Loading...'} - ${data?['namaWajibRetribusi'] ?? 'Loading...'}',
                                                      style: TextStyle(
                                                        fontSize: 16,
                                                        color: Colors.black,
                                                      ),
