...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _fetchPermohonanData() async {
    try {
      final response = await http.get(Uri.parse('http://tapatupa.manoume.com/api/permohonan-mobile/1'));
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  // Row untuk Nomor Permohonan
                                  Text(
                                    'Nomor Permohonan: ${_permohonanData?[0]['nomorSuratPermohonan'] ?? 'Loading...'}',
                                    style: TextStyle(
                                      fontSize: 16,
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              'Jenis Permohonan: ${_permohonanData?[0]['jenisPermohonan'] ?? 'Loading...'}',
                                              style: TextStyle(
                                                fontSize: 16,
                                                color: Colors.black,
                                              ),
                                            ...
                                            SizedBox(height: 10),
                                            Text(
                                              'Tanggal Permohonan: ${_permohonanData?[0]['tanggalDiajukan'] ?? 'Loading...'}',
                                              style: TextStyle(
                                                fontSize: 16,
                                                color: Colors.black,
                                              ),
